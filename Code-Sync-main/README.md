Here is the **full `README.md`** file with the requested modifications, which only includes the **"How to Run or Start the Project"** section, and your name **Deepesh Kumar** as the author:
